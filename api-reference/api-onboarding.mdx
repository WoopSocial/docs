...
4. Many social platforms require a photo or video to publish a post. Use the <a href="/api-reference/media/upload-media?playground=open" target="_blank" rel="noopener noreferrer"><u>Upload media playground</u></a> to upload your file and copy the returned media ID. Again, use the playground to construct the call that you need.
